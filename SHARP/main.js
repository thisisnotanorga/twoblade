...
const SHARP_PORT = process.env.SHARP_PORT ? parseInt(process.env.SHARP_PORT) : 5000;
const HTTP_PORT = process.env.HTTP_PORT ? parseInt(process.env.HTTP_PORT) : SHARP_PORT + 1;
